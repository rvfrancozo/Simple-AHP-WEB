                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="/UpdateSingleScore">
                                ...
                                <select id="newjudment" name="newjudment">
                                    ...
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{7}}">1/7 {{$results->getAlternatives()[$k]['descr']}} is 7x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{6}}">1/6 {{$results->getAlternatives()[$k]['descr']}} is 6x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{5}}">1/5 {{$results->getAlternatives()[$k]['descr']}} is 5x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{4}}">1/4 {{$results->getAlternatives()[$k]['descr']}} is 4x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{3}}">1/3 {{$results->getAlternatives()[$k]['descr']}} is 3x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{2}}">1/2 {{$results->getAlternatives()[$k]['descr']}} is 2x preferable than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1}}">1 {{$results->getAlternatives()[$k]['descr']}} is indifferent than {{$results->getAlternatives()[$i]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/2}}">2 {{$results->getAlternatives()[$i]['descr']}} is 2x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/3}}">3 {{$results->getAlternatives()[$i]['descr']}} is 3x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/4}}">4 {{$results->getAlternatives()[$i]['descr']}} is 4x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/5}}">5 {{$results->getAlternatives()[$i]['descr']}} is 5x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/6}}">6 {{$results->getAlternatives()[$i]['descr']}} is 6x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
                                    <option value="{{$results->getObjectiveId()}};{{$results->getCriteria()[$j]['id']}};{{$results->getAlternatives()[$i]['id']}};{{$results->getAlternatives()[$k]['id']}};{{1/7}}">7 {{$results->getAlternatives()[$i]['descr']}} is 7x preferable than {{$results->getAlternatives()[$k]['descr']}}</option>
